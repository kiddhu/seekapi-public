...
const tasks=[
 ...
 ['AH07','Delivery / local coordination','Coordinate packaging, consolidation, documents and readiness within the agreed role.'],
 ['AH08','Research + human verification','Add human verification to critical entity, contact or business facts.'],
];

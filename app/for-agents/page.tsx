...
export default function Page(){return <PageShell>
  ...
  <section className="section" id="availability"><div className="container"><SectionTitle eyebrow="Current state" title="Manual review preview." body="The task vocabulary, permissions and evidence format are defined. Manual scope questions can be sent by email, but structured web intake, universal coverage, public human-task API, human-task MCP and WebMCP execution are not live on this preview."/><div className="link-list"><Link className="text-link" href="/apis#product-search">Product-data MCP discovery (no payment)</Link><a className="text-link" href="mailto:support@seekapi.ai">Email support@seekapi.ai</a><Link className="text-link" href="/china-compliance-logistics">Compliance, logistics and warehousing</Link><Link className="text-link" href="/trust">Data, role and payment boundaries</Link><Link className="text-link" href="/how-it-works">See the complete operating path</Link></div></div></section>

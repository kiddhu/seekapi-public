...
export default function Page(){return <PageShell>
  <section className="page-hero"><div className="container"><Eyebrow>Start narrow</Eyebrow><h1>Start with one China-side issue.</h1><p>{process.env.NEXT_PUBLIC_INQUIRIES_ENABLED==='1'?'Share your request, contact details and supporting files. We will review your requirements and contact you.':'Choose a company request or Agent handoff. The form checks and prepares an email inside your browser; the website does not upload, store, send or accept the task. You decide whether to send the prepared email.'}</p></div></section>

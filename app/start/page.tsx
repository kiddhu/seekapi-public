...
export default function Page(){return <PageShell>
  <section className="page-hero"><div className="container"><Eyebrow>Start narrow</Eyebrow><h1>Start with one China-side issue.</h1><p>Choose a company request or Agent handoff. The current form checks whether the draft is complete inside your browser. It does not submit, store or accept a task.</p></div></section>
